...
public class ModConfigureFeatures {
    ...
    public static final List<OreConfiguration.TargetBlockState> OVER_WORLD_TOPAZ_ORE = List.of(
            ...
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, RegisterBlocks.TOPAZ_DEEPSLATE_ORE.get().defaultBlockState())
    );
    ...
    public static final List<OreConfiguration.TargetBlockState> OVER_WORLD_CARBONADO_ORE = List.of(
            ...
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, RegisterBlocks.CARBONADO_DEEPSLATE_ORE.get().defaultBlockState())
    );

    public static final List<OreConfiguration.TargetBlockState> OVER_WORLD_RUBY_ORE = List.of(
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> TOPAZ_ORE = FeatureUtils.register("topaz_ore", Feature.ORE, new OreConfiguration(OVER_WORLD_TOPAZ_ORE, 16));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> TOPAZ_DEEPSLATE_ORE = FeatureUtils.register("topaz_deepslate_ore", Feature.ORE, new OreConfiguration(OVER_WORLD_TOPAZ_ORE, 16));

    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> CARBONADO_ORE = FeatureUtils.register("carbonado_ore", Feature.ORE, new OreConfiguration(OVER_WORLD_CARBONADO_ORE, 20));
