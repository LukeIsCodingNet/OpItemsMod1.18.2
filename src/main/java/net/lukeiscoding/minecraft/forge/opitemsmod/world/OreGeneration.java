package net.lukeiscoding.minecraft.forge.opitemsmod.world;
/*
...
import net.lukeiscoding.minecraft.forge.opitemsmod.world.features.ModPlacedFeatures;
...
public class OreGeneration {
    ...
    public static void generateOres(final BiomeLoadingEvent event) {
        ...
        base.add(ModPlacedFeatures.BRASS_ORE_PLACED);
        base.add(ModPlacedFeatures.BRASS_DEEPSLATE_ORE_PLACED);
    }
}
